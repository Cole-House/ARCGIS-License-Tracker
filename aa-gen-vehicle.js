...
module.exports.run = async (targetName) => {
    ...
    // create list folder
    console.log(">>> Creating list folder...")
    fs.mkdirSync(`${projectDir}/${targetName}/${targetName}-list`);

    // Create list component.html file
    sourceFolder = `${templateDir}\\${sourceName}\\${sourceName}-list`;
    sourceFile = `${sourceName}-list.component.html`;
    targetFolder = `${projectDir}/${targetName}/${targetName}-list`;
    targetFile = `${targetName}-list.component.html`;
    copyComponentFile(sourceFolder, sourceFile, targetFolder, targetFile);

    // Create list component.scss file
    sourceFolder = `${templateDir}\\${sourceName}\\${sourceName}-list`;
    sourceFile = `${sourceName}-list.component.scss`;
    targetFolder = `${projectDir}/${targetName}/${targetName}-list`;
    targetFile = `${targetName}-list.component.scss`;
    copyComponentFile(sourceFolder, sourceFile, targetFolder, targetFile);

    // Create list component.ts file
    sourceFolder = `${templateDir}\\${sourceName}\\${sourceName}-list`;
    sourceFile = `${sourceName}-list.component.ts`;
    targetFolder = `${projectDir}/${targetName}/${targetName}-list`;
    targetFile = `${targetName}-list.component.ts`;
    copyComponentFile(sourceFolder, sourceFile, targetFolder, targetFile);
    ...
    function copyComponentFile(sourceFolder, sourceFile, targetFolder, targetFile) {
        ...
        var updated_contents = contents.replace(/XxxVehicle/g, pascal).replace(/xxxVehicle/g, camel).replace(/xxx-vehicle/g, targetName);
